...
export default function Body({ spotifyApi, chooseTrack }) {
  ...
  return (
    <section className=" bg-black ml-24 py-4 space-y-8 md:max-w-6xl flex-grow md:mr-2">
      ...
      <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
        {/* Genres */}
        <div className=" hidden lg:inline-block max-w-[270px]">
        ...
        <div>
          ...
          <div className=" space-y-3 border-2 border-[#262626] rounded-2xl p-3 bg-[#0D0D0D] overflow-y-scroll h-[1000px] w-[830px] md:h-96 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-thumb-rounded hover:scrollbar-thumb-gray-500">
            {searchResults.length === 0
              ? newReleases
